...
export default function Card({cover, date, description, title, slug} : IPost) {
    return (
        <div className='h-[380px] md:h-[400px] lg:h-[440px] flex flex-col'>
            ...
            <p className='text-xs w-full text-right mt-2 text-slate-400'>{date}</p>
            <p className='flex-1 text-sm h-32 w-full text-ellipsis overflow-hidden text-slate-700'>{description}</p>
